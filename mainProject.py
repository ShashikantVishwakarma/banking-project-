    ...
    for line in customer_database:
        if identity == line.replace("\n", ""):
            if choice == 1:
                ...
                customer_database.readline()  # skip pin fro later
...
def delete_customer_account(identity, choice):  # choice 1 for admin, choice 2 for customer
    ...
    for line in customer_database:
        if identity == line.replace("\n", ""):
            flag = 1
            for index in range(11):
                customer_database.readline()  # skip the line
        else:
            data_collector += line
            for index in range(11):
...
def check_credentials(identity, password, choice,
        ...
        for line in database:
            ...
            if id_fetched == identity:
                if ((password == "DO_NOT_CHECK_ADMIN" and choice == 1 and admin_access == False) or (
                    ...
                    database.close()
                    return True
            ## this if statemate is use to varify passoword/user of admin
            if choice == 1:
                database.__next__()
            else:
                for index in range(10):
    ...
    database.close()
    return False
# backend_functions_code_ends. # Tkinter GUI code starts :
class welcomeScreen:
    def __init__(self, window=None):
        ...
        self.Canvas1 = tk.Canvas(window, background="#ffff00", borderwidth="10",relief="ridge")
        self.Canvas1.place(relx=0.190, rely=0.228, relheight=0.496, relwidth=0.622)

        self.Button1 = tk.Button(self.Canvas1, command=self.selectEmployee,background="#8470FF",
                                 text='''EMPLOYEE''')
        ...
        self.Button2 = tk.Button(self.Canvas1, command=self.selectCustomer, background="#8470FF",
                                 text='''CUSTOMER''')
        ...
        self.Label1 = tk.Label(self.Canvas1, background="#ffff00", text='''Please select your role''')
...
class Error:
    def __init__(self, window=None):
        ...
        self.Button1 = tk.Button(window, background="#d3d8dc", borderwidth="1",
    ...
    def setMessage(self, message_shown):
        Label2 = tk.Label(master, background="#f2f3f4", text=message_shown)
...
class adminLogin:
    def __init__(self, window=None):
        ...
        self.Label1 = tk.Label(Canvas1, background="#ffffff",font="-family {Segoe UI} -size 14 -weight bold",
                               text="Admin Login")
        ...
        self.Button = tk.Button(Canvas1, text="Login", borderwidth="0", width=10, background="#BDFCC9",
                                command=lambda: self.login(self.Entry1.get(), self.Entry1_1.get()))
        self.Button.place(relx=0.765, rely=0.755)

        self.Button_back = tk.Button(Canvas1, text="Back", borderwidth="0", width=10, background="#BDFCC9",
                                     command=self.back)
...
class CustomerLogin:
    def __init__(self, window=None):
        ...
        Label1 = tk.Label(Canvas1, background="#ffffff",font="-family {Segoe UI} -size 14 -weight bold",
                          text="Customer Login")
        ...
        self.Button = tk.Button(Canvas1, text="Login", borderwidth="0", width=10, background="#8470FF",
                                foreground="#ffffff",
                                font="-family {Segoe UI} -size 10 -weight bold",
                                command=lambda: self.login(self.Entry1.get(), self.Entry1_1.get()))
        self.Button.place(relx=0.765, rely=0.755)

        self.Button_back = tk.Button(Canvas1, text="Back", background="#8470FF",
                                     foreground="#ffffff",
                                     font="-family {Segoe UI} -size 10 -weight bold",
                                     command=self.back)
        self.Button_back.place(relx=0.545, rely=0.755)
...
class CloseAccountByAdmin:
    def __init__(self, window=None):
        ...
        self.Label1 = tk.Label(window, background="#f2f3f4",text='''Enter account number:''')
        ...
        self.Button1 = tk.Button(window, background="#004080",text="Back",
                                 command=self.back)
        self.Button1.place(relx=0.230, rely=0.598, height=24, width=67)

        self.Button2 = tk.Button(window, background="red", text="Proceed",
...
class createCustomerAccount:
    def __init__(self, window=None):
        ...
        self.Label1 = tk.Label(window, background="#f2f3f4", text='''Account number:''')
        self.Label1.place(relx=0.219, rely=0.025, height=26, width=120)

        self.Label2 = tk.Label(window, background="#f2f3f4", text='''Full name:''')
        ...
        self.Label3 = tk.Label(window, background="#f2f3f4",text='''Account type:''')
        self.Label3.place(relx=0.287, rely=0.169, height=26, width=83)

        global acc_type
        acc_type = StringVar()

        self.Radiobutton1 = tk.Radiobutton(window, background="#f2f3f4",justify='left',
                                           text='''Savings''', variable=acc_type, value="Savings")
        self.Radiobutton1.place(relx=0.511, rely=0.174, relheight=0.057, relwidth=0.151)

        self.Radiobutton1_1 = tk.Radiobutton(window, background="#f2f3f4",justify='left',
        ...
        self.Label5 = tk.Label(window,background="#f2f3f4",text='''Mobile number:''')
        self.Label5.place(relx=0.268, rely=0.323, height=22, width=85)

        self.Label4 = tk.Label(window, background="#f2f3f4",text='''Birth date (DD/MM/YYYY):''')
        ...
        self.Label6 = tk.Label(window,background="#f2f3f4",text='''Gender:''')
        self.Label6.place(relx=0.345, rely=0.402, height=15, width=65)

        global gender
        gender = StringVar()

        self.Radiobutton3 = tk.Radiobutton(window, background="#f2f3f4",justify='left',
                                           text='''Male''', variable=gender, value="Male")
        self.Radiobutton3.place(relx=0.481, rely=0.397, relheight=0.055, relwidth=0.175)

        self.Radiobutton4 = tk.Radiobutton(window,background="#f2f3f4",justify='left',
        ...
        self.Label7 = tk.Label(window,background="#f2f3f4", text='''Nationality:''')
        ...
        self.Label9 = tk.Label(window,background="#f2f3f4", text='''PIN:''')
        self.Label9.place(relx=0.399, rely=0.62, height=21, width=35)

        self.Label10 = tk.Label(window,background="#f2f3f4", text='''Re-enter PIN:''')
        self.Label10.place(relx=0.292, rely=0.695, height=21, width=75)

        self.Label11 = tk.Label(window, background="#f2f3f4", text='''Initial balance:''')
        self.Label11.place(relx=0.292, rely=0.779, height=21, width=75)

        self.Button1 = tk.Button(window,background="#004080", text='''Back''', command=self.back)
        self.Button1.place(relx=0.243, rely=0.893, height=24, width=67)

        self.Button2 = tk.Button(window,background="#004080", text='''Proceed''',
        ...
        self.Label8 = tk.Label(window, background="#f2f3f4",text='''KYC document name:''')
...
class createAdmin:
    def __init__(self, window=None):
        ...
        self.Label1 = tk.Label(window, background="#f2f3f4",text='''Enter admin ID:''')
        self.Label1.place(relx=0.219, rely=0.067, height=27, width=104)

        self.Label2 = tk.Label(window, background="#f2f3f4",text='''Enter password:''')
        ...
        self.Label3 = tk.Label(window, text='''Confirm password:''')
        ...
        self.Button1 = tk.Button(window, background="#004080", text="Proceed",
        ...
        self.Button2 = tk.Button(window,background="#004080",text="Back",
                                 command=self.back)
...
class customerMenu:
    def __init__(self, window=None):
        ...
        self.Labelframe1 = tk.LabelFrame(window,text='''Select your option''', background="#fffffe")
        self.Labelframe1.place(relx=0.081, rely=0.081, relheight=0.415, relwidth=0.848)

        self.Button1 = tk.Button(self.Labelframe1, command=self.selectWithdraw,foreground='white', background='green',
          activeforeground='red', activebackground='blue', text='''Withdraw''')
        self.Button1.place(relx=0.667, rely=0.195, height=34, width=181, bordermode='ignore')

        self.Button2 = tk.Button(self.Labelframe1, command=self.selectDeposit,foreground='white', background='green',
          activeforeground='red', activebackground='blue',  text='''Deposit''')
        self.Button2.place(relx=0.04, rely=0.195, height=34, width=181, bordermode='ignore')

        self.Button3 = tk.Button(self.Labelframe1, command=self.exit,foreground='white', background='green',
          activeforeground='red', activebackground='blue',text='''Exit''')
        self.Button3.place(relx=0.667, rely=0.683, height=34, width=181, bordermode='ignore')

        self.Button4 = tk.Button(self.Labelframe1, command=self.selectChangePIN,foreground='white', background='green',
          activeforeground='red', activebackground='blue',text='''Change PIN''')
        self.Button4.place(relx=0.04, rely=0.439, height=34, width=181, bordermode='ignore')

        self.Button5 = tk.Button(self.Labelframe1, command=self.selectCloseAccount,foreground='white', background='green',
          activeforeground='red', activebackground='blue',text='''Close account''')
        self.Button5.place(relx=0.667, rely=0.439, height=34, width=181, bordermode='ignore')

        self.Button6 = tk.Button(self.Labelframe1,foreground='white', background='green',
          activeforeground='red', activebackground='blue',text='''Check your balance''',
                                 command=self.checkBalance)
        self.Button6.place(relx=0.04, rely=0.683, height=34, width=181, bordermode='ignore')

        ##################################################################

####frame of output in customer log in
        global Frame1_1_2
...
class depositMoney:
    def __init__(self, window=None):
        ...
        self.Label1 = tk.Label(window, text='''Enter amount to deposit :''')
        self.Label1.grid(row=2,column=1)

        self.Entry1 = tk.Entry(window,background="#6495ED")
        self.Entry1.grid(row=2,column=2)

        self.Button1 = tk.Button(window,background="#6495ED",text='''Proceed''',command=lambda: self.submit(self.Entry1.get()))
        self.Button1.grid(row=3,column=3)

        self.Button2 = tk.Button(window,background="#6495ED", text='''Back''',command=self.back)
...
class withdrawMoney:
    def __init__(self, window=None):
        self.master = window
        window.geometry("411x117+519+278")
        window.title("withdraw_day")

        self.Label1 = tk.Label(window,text='''Enter amount to withdraw :''')
        self.Label1.place(relx=0.146, rely=0.171, height=21, width=164)

        self.Entry1 = tk.Entry(window,background="#f2f3f4")
        self.Entry1.place(relx=0.535, rely=0.171, height=20, relwidth=0.253)

        self.Button1 = tk.Button(window,background="#6495ED", text='''Proceed''',
                                 command=lambda: self.submit(self.Entry1.get()))
        self.Button1.place(relx=0.56, rely=0.598, height=24, width=67)

        self.Button2 = tk.Button(window,background="#6495ED",text='''Back''',
                                 command=self.back)
...
class changePIN:
    def __init__(self, window=None):
        ...
        self.Label1 = tk.Label(window, text='''Enter new PIN:''')
        self.Label1.pack()
        self.Entry1 = tk.Entry(window, show="*")
        self.Entry1.pack()

        self.Label2 = tk.Label(window, text='''Confirm PIN:''')
        self.Label2.pack()
        self.Entry2 = tk.Entry(window, show="*")
        self.Entry2.pack()
    ...
    def submit(self, new_PIN, confirm_new_PIN):
        if new_PIN == confirm_new_PIN and str(new_PIN).__len__() == 4 and new_PIN.isnumeric():
            ...
            if new_PIN != confirm_new_PIN:
                ...
                Error.setMessage(self, message_shown="Invalid PIN!")
            return
    ##customer back button in pin change
    def back(self):
        self.master.withdraw()
...
class closeAccount:
    def __init__(self, window=None):
        ...
        self.Label1 = tk.Label(window,text='''Enter your PIN:''')
        self.Label1.pack()
...
class checkAccountSummary:
    def __init__(self, window=None):
        ...
        self.Label1 = tk.Label(window,text='''Enter ID :''')
        self.Label1.pack()
